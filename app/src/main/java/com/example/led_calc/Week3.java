...
public class Week3 extends AppCompatActivity {
    ...
    void showNumber() {
        ...
        if (number_str.length() == 1) {
            ...
            setNumber(findViewById(R.id.led0), number_str.charAt(0));
        } else if (number_str.length() == 2) {
            setNumber(findViewById(R.id.led1), number_str.charAt(0));
            setNumber(findViewById(R.id.led0), number_str.charAt(1));
        }
    }
